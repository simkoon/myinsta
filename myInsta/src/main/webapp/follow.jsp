                                    ...
                                    <li class="people__person">
                                        <div class="people__column">
                                            <div class="people__avatar-container">
                                                <a href="#">
                                                    <img src="images/follower.png" class="people__avatar" />
                                                </a>
                                            </div>
                                            <div class="people__info">
                                                ...
                                                <span class="people__full-name">David Beckham 님이 회원님을 팔로우하기
                                                    시작했습니다. 3일</span>
                                            </div>
                                        </div>
                                        <div class="people__column">
                                            <input type="button" id="columnbutton" value="팔로우" class="btnFolloing"  />
                                        </div>
                                    </li>
                                    <li class="people__person">
                                        <div class="people__column">
