		...
		<nav>
			...
			<div class="header_meun">
				<div class="h_meun">
					...
					<div class="h_meunlist">
						<a class="m_dm" href="dm.jsp"> <svg aria-label="메세지보내기"
								class="ico_btn" " fill="#262626" height="22" viewBox="0 0 48 48"
								width="22">
                            <path
					...
					<div class="h_meunlist">
						<a class="m_like" href="#"> <svg aria-label="활동피드"
								class="ico_btn hd_heart" fill="#262626" height="22" viewBox="0 0 48 48"
								width="22">
                            <path
                         ...
                         <div class="hd_heart_sub">
                                            <div class="sub_prices">
                                                ...
                                                <div class="pr3">
                                                    <p><input type="button" value="팔로잉" class="f_btn"></p>
                                                </div>
                                            </div>
                                            <div class="sub_prices">
                                                <div class="pr1">
